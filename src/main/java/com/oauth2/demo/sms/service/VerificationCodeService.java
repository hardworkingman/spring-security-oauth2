...
public interface VerificationCodeService {
     ...
     * @return
     * 验证码长度和过期时间采用默认配置
     * 验证码长度配置项：hlhlo.vc.size 默认值：4<br/>
     * 验证码过期时间配置项：hlhlo.vc.expire 默认值：180000(3分钟)
     */
    String getToken(Integer size, Long expire, String type, String subject);

    Map<String, String> getTokenAndCode(Integer size, Long expire, String type, String subject);
     ...
     * 短信模板配置项：hlhlo.vc.sms.templateCode<br/>
     * 短信签名配置项：hlhlo.vc.sms.signName<br/>
     * 验证码参数名配置项：hlhlo.vc.sms.codeParamName<br/>
